...
class _TransactionPageState extends State<TransactionPage> {
  ...
  Category? selectedCategory;
    ...
    Future insert(
      ...
      final row  = 
      await database.into(database.transactions)
      .insertReturning(TransactionsCompanion.insert
      (name: nameDetail, category_id: categoryId, transaction_date: date, amount: amount, createdAt: now, updateAt: now, updated_at: now, created_at: now, description: ''));
            ...
            Center(
              child: ElevatedButton(
                ...
                (widget.transactionWithCategory == null) ? 
                 insert(int.parse(amountController.text), 
                 DateTime.parse(dateController.text),
                 detailController.text, 
                 selectedCategory!.id) : update(widget.transactionWithCategory!.transaction.id,
